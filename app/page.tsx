...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
            ...
            <section className="container mx-auto px-6 md:px-4 py-12 md:py-16 pb-6 md:pb-8 text-center relative overflow-hidden">
              ...
              <BlurFade delay={0.25} duration={0.2}>
                <h1 className="text-4xl font-medium md:text-6xl lg:text-7xl md:font-normal mb-6 max-w-5xl mx-auto leading-tight">
                  SAY HELLO TO YOUR 
                  <span className="text-[var(--brand-color-text)] italic font-bold gradient-text"> SMARTER </span> 
      ...
      <GradientBackground variant="accent" className="relative">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white/10 via-[#fff8fe]/30"></div>
        ...
        <WaveDivider fillColor="fill-white" direction="down" />
        
        <GradientBackground variant="light" className="pt-4">
          <BlurFade delay={0.65} duration={0.2}>
            <div className="container mx-auto px-4 md:px-6 py-10">
              <h2 className="text-3xl md:text-5xl font-bold text-center mb-6 fade-in-section">
                <span className="text-[var(--brand-color-text)] italic gradient-text">AI Solutions</span> for Your Business
              </h2>
